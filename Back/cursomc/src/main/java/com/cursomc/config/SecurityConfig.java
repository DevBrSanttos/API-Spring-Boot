...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// Permitir que outras aplicações façam requisições
		http.cors().and().csrf().disable();
		
		// Permitir acesso as URL listadas e para todas as outras exigir authenticação
	...
	// Configuração para criptografar a senha do Cliente
	@Bean
